    ...
    <div class="container">
        ...
        <div class="contact-info-grid">
            <div class="info-card-modern">
                ...
                <p><strong>Rakesh Rajendra Singh</strong></p>
                <p class="small-text">DoB: 16-01-1990</p>
            </div>
            <div class="info-card-modern">
                <div class="card-icon">📱</div>
                <h3>Call Us</h3>
                <p><a href="tel:9619501369">+91 9619501369</a></p>
                <p class="small-text">Mon-Sun, 24/7 Available</p>
            </div>
            <div class="info-card-modern">
                <div class="card-icon">📧</div>
                <h3>Email Us</h3>
                <p><a href="mailto:contact@live18india.com">contact@live18india.com</a></p>
                <p class="small-text">We'll reply within 24 hours</p>
            </div>
            <div class="info-card-modern">
                <div class="card-icon">📍</div>
                <h3>Visit Us</h3>
                <p>Mira Road East, Mumbai</p>
                <p class="small-text">Maharashtra - 401107</p>
            </div>
        </div>
            ...
            <div class="contact-details-sidebar">
                ...
                <div class="detail-card">
                    ...
                    <div class="detail-card-body">
                        <p><strong>Flat 302, Venkatesh Appartment</strong></p>
                        <p>Near Raval Nagar</p>
                        <p>Behind Station Road</p>
                        <p>Mira Road East, Mumbai</p>
                        <p>Maharashtra - 401107</p>
                        <div class="landmark">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                            <span>Landmark: Mira Road Station Bhaji Market</span>
                        </div>
                    </div>
                </div>
